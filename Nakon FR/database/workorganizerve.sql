...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2017 at 04:03 PM
...
(1, 'goca', 'This regression needs to be runned from work folder.');
...
CREATE TABLE IF NOT EXISTS `task_comments` (
  ...
  PRIMARY KEY (`id_task`,`id_comment`),
...
INSERT INTO `task_comments` (`id_task`, `id_comment`) VALUES
(1, 1);
...
ALTER TABLE `task_comments`
  ADD CONSTRAINT `task_comments_ibfk_2` FOREIGN KEY (`id_task`) REFERENCES `tasks` (`id`),
  ADD CONSTRAINT `task_comments_ibfk_1` FOREIGN KEY (`id_comment`) REFERENCES `comments` (`id`);
